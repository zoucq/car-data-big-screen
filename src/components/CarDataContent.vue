                        ...
                        <div class="info-main">
                            <div class="info-1">
                                ...
                                <div class="info-text fl">
                                    <p>车辆总数(辆)</p>
                                    <p><countTo :startVal='0' :endVal='carTotal' :duration='countDuration'></countTo></p>
                                </div>
                            </div>
                            <div class="info-2">
                                <div class="info-img fl">
                                ...
                                <div class="info-text fl">
                                    <p>当前在线数(辆)</p>
                                    <p><countTo :startVal='0' :endVal='carOnLineTotal' :duration='countDuration'></countTo></p>
                                </div>
                            </div>
                            <div class="info-3">
                                <div class="info-img fl">
                                ...
                                <div class="info-text fl">
                                    <p>今日活跃数(辆)</p>
                                    <p><countTo :startVal='0' :endVal='carNowDayActiveTotal' :duration='countDuration'></countTo></p>
                                </div>
                            </div>
                            <div class="info-4">
                                <div class="info-img fl">
                                ...
                                <div class="info-text fl">
                                    <p>今日活跃率(%)</p>
                                    <p><countTo :startVal='0' :endVal='carNowDayActiveRate' :duration='countDuration'></countTo></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="map-num">
                    ...
                    <div class="num">
                        <span class="num_count"
                              :class="{sp: isNaN(item)}"
                              v-for="(item,index) in carTimeCount" :key="index">
                          <i class="t" v-if="isNaN(item)">,</i>
                          <i class="c" v-else ref="numberItem">0123456789</i>
                        </span>
                    </div>
                </div>
...
require('@/utils/echarts/china.js')
        ...
        xAxis : [
            {
                ...
                axisLabel: {
                    ...
                    formatter: function(params){
                        ...
                        // console.log(11,params, newParamsName);
                        //将最终的字符串返回
...
function echarts_5() {
    ...
    let xData = function() {
        let data = ['NO.1','NO.2','NO.3','NO.4','NO.5'];

        return data;
    }();

    let data = [28, 22, 20, 16, 12]
...
export default {
    ...
    data () {
        return {
            carTimeCount: [],
            carTotal: 32456,
            carOnLineTotal: 12153,
            carNowDayActiveTotal: 10457,
            carNowDayActiveRate: 0,
            countDuration: 3000
        }
    },
    mounted() {
    ...
    methods: {
        initCarData () {
            // 今日活跃率
            this.carNowDayActiveRate = (this.carNowDayActiveTotal / this.carOnLineTotal).toFixed(2) * 100

            // 实时行驶车辆动画
            this.toOrderNum(this.numFormat('000000000'))
            setTimeout(() => {
                this.toOrderNum(this.numFormat(687982382))
            }, 1500)
        },
        toOrderNum(t){
            this.carTimeCount = t.toString().split("")
            this.setNumberTransform()
        },
        setNumberTransform() {
            this.$nextTick(() => {
                // console.log(1223, this.$refs.numberItem);
                for (let t = this.$refs.numberItem, e = this.carTimeCount.filter((t) => {
                    return !isNaN(t)
                }), a = 0; a < t.length; a++) {
                    let item = t[a];
                    item.style.transform = "translate(-50%, -".concat(10 * e[a], "%)")
                }
            })
        },
        numFormat(num){
